...
{
    products.Add(new Product { Id = 1, Name = "Product A", Price = 12.99m });
    products.Add(new Product { Id = 2, Name = "Product B", Price = 23.99m });
    products.Add(new Product { Id = 3, Name = "Product C", Price = 34.99m });
}
